		...
		*/
		_getHttpAdapter: function(adapterName) {
			...
			if (adapterName === 'https') {
				var HttpsAdapter = new require('./httpadapter/httpsadapter.js');
		...
		*/
		_getGeocoder: function(geocoderName, adapter, extra) {
			if (geocoderName === 'google') {
				...
				return new GoogleGeocoder(adapter, {clientId: extra.clientId, apiKey: extra.apiKey, language: extra.language, region: extra.region});
			}
